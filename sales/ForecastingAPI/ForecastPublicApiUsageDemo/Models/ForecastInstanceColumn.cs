...
namespace Microsoft.Dynamics.Forecasting.Common.Models
{
    ...
    public class ForecastInstanceColumn
    {
        ...
        /// <summary>
        /// Display value with currency labels
        /// </summary>
        public string SystemDisplayValue { get; set; }
        ...
        /// <summary>
        /// true if manual adjusted
        /// </summary>
        public bool IsManualAdjusted { get; set; }

        /// <summary>
        /// Can Manual Adjustment be done for this record based on FI being part of Loggedin User's Hierarchy.
        /// Value will only be computed during FI fetch and may vary based on User.
        /// </summary>
        public bool IsEditable { get; set; }

        /// <summary>
        /// Can show history be enabled for this Cell.
        /// This is based on IsEditable from FCC and If ManualAdjustment is done by Logged in user.
        /// </summary>
        ...
        /// Initially this will be null and once adjustment is done then onwards it will have some value
        /// </summary>
        ...
        /// <summary>
        /// Count of participating records by pivot
        /// </summary>
        public ParticipatingRecordsInfoByPivot ParticipatingRecordsInfoByPivot { get; set; }
    }
}
