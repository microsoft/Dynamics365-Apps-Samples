...
namespace PowerApps.Samples
{
    public partial class SampleProgram
    {
        ...
        private static void DistributeCampaign(CrmServiceClient service)
        {
            ...
            NotifyEntityCreated(service, Campaign.EntityLogicalName, _originalCampaignId);
            ...
            NotifyEntityCreated(service, CampaignActivity.EntityLogicalName, _campaignActivityId);
        ...
        private static void CreateMarketingList(CrmServiceClient service)
        {
            ...
            NotifyEntityCreated(service, List.EntityLogicalName, _marketingListId);
        ...
        private static void NotifyEntityCreated(CrmServiceClient service, string entityName, Guid entityId)
        {
